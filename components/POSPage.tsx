...
import { ShoppingCart, Plus, Minus, ChefHat, Utensils, User, Phone, Clock, ShoppingBag } from "lucide-react";
...
export default function POSPage({ menuItems, categories }: { menuItems: MenuItem[], categories: Category[] }) {
  ...
  const [selectedCategory, setSelectedCategory] = useState<number>(0); // 0 代表全部
